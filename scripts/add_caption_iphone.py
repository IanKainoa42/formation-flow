...
CONFIGS={
 ...
 "pdf": dict(floor="pdf_export_iphone.png", out="iphone_05_pdf.png", accent=CYAN,
   tag="PDF PLAYBOOK EXPORT",
   lines=[[("Hand your team",WHITE)],[("a ",WHITE),("playbook.",CYAN)]],
   sub="Every formation, path and count — exported as a printable PDF."),
